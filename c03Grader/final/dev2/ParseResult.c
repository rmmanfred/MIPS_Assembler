...
/**
 * Pre-Condition: n is between 1 and 4
 * Post-Condition: Out will contain ascii binary string of c
 * Prints out ascii rep in binary
 */
static int asciiPrint(FILE* Out, int n, char c)
{
...
/**
 * Sets data positions for symbols switch
 */
